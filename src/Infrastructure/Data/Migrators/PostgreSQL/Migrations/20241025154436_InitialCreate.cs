    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<string>(type: "character varying(26)", nullable: false),
                    province_id = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    address_province_id = table.Column<string>(
                        type: "character varying(26)",
                        nullable: true
                    ),
                    address_district_id = table.Column<string>(
                        type: "character varying(26)",
                        nullable: true
                    ),
                    address_commune_id = table.Column<string>(
                        type: "character varying(26)",
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    role_claim_id = table.Column<string>(
                        type: "character varying(26)",
                        nullable: true
                    ),
                    created_at = table.Column<DateTimeOffset>(
        ...
        {
            migrationBuilder.DropTable(name: "user_claim");
            ...
            migrationBuilder.DropTable(name: "role_claim");

            migrationBuilder.DropTable(name: "user");

            migrationBuilder.DropTable(name: "role");

            migrationBuilder.DropTable(name: "commune");

            migrationBuilder.DropTable(name: "district");

            migrationBuilder.DropTable(name: "province");
        }
    }
}
